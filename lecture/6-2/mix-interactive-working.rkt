...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname mix-interactive-working) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
; and a third square (with color when the two is mixed) overlaid on top
